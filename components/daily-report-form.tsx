...
import { gregorianToJalali, isValidTime, jalaliToGregorian, parseJalaliDate } from "@/lib/date/jalali";
            ...
            <div className="wizard-fields">
              {step === 0 && <>
                ...
                <div className="report-datetime-grid">
                  ...
                  <label className="field"><span className="field-label">ساعت ورود <span className="required-mark">ضروری</span></span><span className="time-input-wrap time-picker-wrap"><Clock3 /><input className="input time-picker-input" type="time" step="300" autoComplete="off" aria-label="انتخاب ساعت ورود" dir="ltr" value={form.startTime} onChange={(event) => update("startTime", event.target.value)} /></span></label>
                  <label className="field"><span className="field-label">ساعت خروج <span className="required-mark">ضروری</span></span><span className="time-input-wrap time-picker-wrap"><Clock3 /><input className="input time-picker-input" type="time" step="300" autoComplete="off" aria-label="انتخاب ساعت خروج" dir="ltr" value={form.endTime} onChange={(event) => update("endTime", event.target.value)} /></span></label>
                </div>
