        ...
        <section className="surface employee-form-card employee-form-simple">
          ...
          <form onSubmit={handleSubmit(submit)} autoComplete="off" noValidate>
            <div className="employee-fields">
              <label className="field"><span className="field-label">نام کارمند</span><span className="field-with-icon"><UserRound /><input className="input" autoComplete="off" aria-invalid={Boolean(errors.fullName)} {...register("fullName")} /></span>{errors.fullName && <small className="field-error">{errors.fullName.message}</small>}</label>
