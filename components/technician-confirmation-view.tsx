      ...
      {needsPromisedReturn && <section className="confirmation-promised-field">
        ...
        <div className="confirmation-promised-controls">
          <div className="confirmation-promised-control confirmation-promised-date jalali-picker-field">
            ...
            {datePickerOpen && <><button type="button" className="jalali-picker-backdrop" style={{ position: "fixed", zIndex: 120, inset: 0, border: 0, background: "rgba(20,32,25,.26)", backdropFilter: "blur(2px)" }} aria-label="بستن تقویم" onClick={() => setDatePickerOpen(false)} /><div className="jalali-picker-panel" style={{ position: "fixed", zIndex: 121, top: "50%", right: "50%", left: "auto", width: "min(calc(100vw - 32px), 360px)", transform: "translate(50%, -50%)" }} role="dialog" aria-modal="true" aria-label="تقویم شمسی">
